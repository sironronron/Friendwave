...
class CreateUserProfilesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_profiles', function (Blueprint $table) {
            ...
            // Images
            $table->string('picture_big_url');
            $table->string('picture_small_url');
            $table->string('picture_url');

            $table->string('cover_picture_big_url');
            $table->string('cover_picture_small_url');
            $table->string('cover_picture_url');
            ...
            $table->unsignedBigInteger('significant_other_id');
